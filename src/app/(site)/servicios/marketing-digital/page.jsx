...
function MarketingDigital() {
  ...
  return (
    <>
      ...
      <BackgroundVideo
        mp4Src="/servicios/marketing_digital/marketing_digital_banner.webm"
        mp4SrcMobile="/servicios/marketing_digital/marketing_digital_banner_responsive.webm"
        hideOnMobile
        pauseWhenOffscreen
      ...
      >
        <section className="mx-auto max-w-5xl px-4 sm:px-6 md:px-8 lg:px-12 py-4">
          <p className="text-lg text-center">
            Creamos marcas que nacen de una creencia, diseñamos experiencias que
            trascienden la pantalla y gestionamos cada interacción con
